...
/**
 * Formats a given value according to the standards for OData 2.0 URL parameters
 *
 * - `=FormatAsOData2UrlParam('2022-05-29 20:23', 'Edm.DateTime')` -> `datetime'2022-05-29T20:23:51'`
 * - `=FormatAsOData2UrlParam('2022-05-29 20:23', 'Edm.Time')` -> `PT20H23M51S`
 * - `=FormatAsOData2UrlParam('20:23', 'Edm.Time')` -> `PT20H23M51S`
 *
 * ## Supported formats
 *
 ...
 *
 * For more details, see https://www.odata.org/documentation/odata-version-2-0/overview/ chapter 6.
 *
 * @author Andrej Kabachnik
 *
 */
class FormatAsOData2UrlParam extends Formula
{
    /**
     * 
     * {@inheritDoc}
    ...
    public function run($value = null, string $odataType = 'Edm.String')
    {
        ...
        return OData2JsonUrlBuilder::buildUrlFilterODataValue($value, null, $odataType);
    }
}